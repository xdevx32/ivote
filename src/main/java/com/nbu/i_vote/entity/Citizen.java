...
public class Citizen {
    ...
    public Citizen(long id, String name, String EGN, LocalDate dayOfBirth, @Nullable Ballot ballot, String city, String uniqueVoteId, @Nullable Boolean hasVoted) {
        this.id = id;
        this.name = name;
        this.EGN = EGN;
